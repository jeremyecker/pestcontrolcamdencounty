...
export const metadata: Metadata = generatePageMetadata({
  ...
  description: `${SITE_NAME} is locally owned and operated, protecting homes and families with effective, family-friendly pest control. ${GMB.rating} stars from verified customers.`,
  path: '/about',
});
      ...
      <section className="py-12 lg:py-16">
        <div className="max-w-4xl mx-auto px-4 prose-content">
          ...
          <p className="text-lg text-gray-600 mb-8">
            ...
            home the way we&apos;d treat our own. That&apos;s why families across {GEO.region} have
            given us a {GMB.rating}-star rating on Google.
          </p>
          ...
          <p>
            We serve every town across {GEO.region}. Wherever you call home,

      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <section className="mb-10">
          ...
          <div className="prose prose-lg max-w-none">
            <p>Ants are the #1 pest call we receive from Camden County homeowners every spring &mdash; and for good reason. Camden County&rsquo;s mix of older suburban neighborhoods, wooded lots, and dense residential communities creates ideal conditions for carpenter ants, odorous house ants, and pavement ants to thrive. Our ant exterminators — licensed or working under the direct supervision of a licensed applicator — serve the entire county, from Cherry Hill and Voorhees to Gloucester Township, Haddonfield, Pennsauken, and beyond.</p>

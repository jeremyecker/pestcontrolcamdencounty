...
export default function CTABanner({
  ...
  subtitle = 'Your family deserves a home without pests. Get a free estimate from your local experts — family-friendly treatments, honest pricing, and no obligation.',
}: CTABannerProps) {
  return (

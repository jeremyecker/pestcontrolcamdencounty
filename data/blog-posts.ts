...
import { BLOG_POSTS_WAVE6 } from './blog-wave6-posts';
import { BLOG_POSTS_WAVE7 } from './blog-wave7-posts';
...
export function getAllBlogPosts(): BlogPost[] {
  return [...BLOG_POSTS, ...BLOG_POSTS_WAVE2, ...BLOG_POSTS_WAVE3, ...BLOG_POSTS_WAVE4, ...BLOG_POSTS_WAVE5, ...BLOG_POSTS_WAVE6, ...BLOG_POSTS_WAVE7];
}

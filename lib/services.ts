...
export function getServiceDescription(slug: string): string {
  const descriptions: Record<string, string> = {
    ...
    'raccoon-removal':
      'Professional raccoon removal and exclusion services in Camden County, NJ. Raccoons frequently invade attics, chimneys, and crawl spaces in neighborhoods near Cooper River Park, Winslow Township wooded corridors, and older homes in Haddonfield and Collingswood. Our wildlife technicians — licensed or working under the direct supervision of a licensed applicator — use humane live-trapping methods approved by the NJDEP, seal all entry points, and sanitize contaminated areas to protect your family from raccoon roundworm and other health hazards.',
    'squirrel-removal':
